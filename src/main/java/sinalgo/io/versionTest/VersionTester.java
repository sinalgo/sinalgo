...
public class VersionTester extends Thread {
	 ...
	 *
	 * @param testIfEnabled
	 *            Set to true if the check should only be performed if the AppConfig
	 *            file is configured to perform update checks.
	 * @param displayIfVersionMatch
	 *            Set to true if a message should also be displayed if the installed
